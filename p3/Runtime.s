...
!
! ==========  THIS VERSION IS TO SUPPORT THE BLITZ OS PROJECT  ==========
!
...
TimerInterruptHandler:
	...
	push	r2				! .  interrupted threads system stack
	push	r3				! .
	push	r4				! .
	push	r5				! .
	push	r6				! .
...
DiskInterruptHandler:
	set	ExceptMess11,r1			! Print an error message
	jmp	printRuntimeError		! .  and terminate all execution

SerialInterruptHandler:
	set	ExceptMess12,r1			! Print an error message
	jmp	printRuntimeError		! .  and terminate all execution
...
SyscallTrapHandler:
	set	STACK_START,r15			! Reset stack so printing works
	set	ExceptMess10,r1			! Print an error message
	jmp	printRuntimeError		! .  and terminate all execution
...
_runtimeErrorDifferentArraySizes:
	...
	pop	r1			! .
	jmp	TerminateRuntime	! Cant continue: invoke "debug"
